...
// Mortal Boards. - (Please Name Accordingly)

 {199, 0, 0, LVL_GOD, "etc/board/mortal/general", 0},
 {198, 0, 0, LVL_GOD, "etc/board/mortal/social", 0},
 {197, 0, 0, LVL_GOD, "etc/board/mortal/auction", 0},

// Immortal Boards. - (Please Name Accordingly)

  {1200, LVL_GRGOD, LVL_GRGOD, LVL_IMPL, "etc/board/god/imps", 0},
  {1201, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/general", 0},
  {1202, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/ideas", 0},
  {1203, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/quest", 0},
  {1204, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/public", 0},
  {1205, LVL_IMMORT, LVL_FREEZE, LVL_IMPL, "etc/board/god/freeze", 0},
  {1206, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/typos", 0},
  {1207, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/bugs", 0},
  {1208, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/imburse", 0},
  {1209, LVL_IMMORT, LVL_IMMORT, LVL_GRGOD, "etc/board/god/build", 0}
// Clan Boards. - (can't get this working)
};
